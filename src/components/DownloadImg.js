  ...
  return (
    <div className='TextDI'>
      <section className='section1'>
        ...
        <p className='note'>{props.note}<img src={Check} alt='check'></img></p>
        </section>

        <hr></hr>

        <section className='section2'>
        <h2 className='pro'>Pro <img src={New} alt='new' className='newPro'></img></h2>
        <p>1280X1920 תמונה מלאה</p>
        <button className='leftBtn'>{downloadPro}</button>
        <p className='note'>איכות טובה עד 25 מגה פיקסל<img src={Check} alt='check'></img></p>
        </section>
